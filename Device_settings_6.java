 ...
 */
public class Device_settings_6 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable  Bundle savedInstanceState) {
        ViewGroup rootView = (ViewGroup) inflater.inflate(R.layout.layout_device_settings_frag6,container,false);
        ...
        aHand_toggleB.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if(aHand_toggleB.isChecked()){
                    String order_on = "1024";
                    send_data(order_on);
                }
                else{
                    String order_off = "4201";
                    send_data(order_off);
                }
            }
        });
        ...
        Set.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if((On_editText.length() > 0)&&(editText2.length() > 0)) {
                    degree_data_send = On_editText.getText().toString() + 6;
                    send_data(String.valueOf(degree_data_send));

                    SystemClock.sleep(500);

                    degree_data_send2 = editText2.getText().toString() + 6;
